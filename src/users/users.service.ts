...
import { adminConfigFactory, userConfigFactory } from "@Config";
...
//   VerifyCodeResponse,
// } from "../otp";
import { ContactMailParams } from "./types";
...
export class UsersService {
  constructor(
    ...
    private readonly adminConfig: ConfigType<typeof adminConfigFactory>,
  ...
  async contactAdmin(data: {
    email: string;
    contactNumber: string;
    message: string;
  }) {
    const email1 = this.adminConfig.email1;
    const email2 = this.adminConfig.email2;
    if (!email1 || !email2) {
